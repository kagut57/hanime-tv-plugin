...
from yt_dlp.utils import traverse_obj, str_or_none, int_or_none, url_or_none, urljoin, clean_html, OnDemandPagedList
...
class HanimeTVPlaylistIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        num_page_ents = int_or_none(
            self._configuration_arg('num_page_ents', ie_key=HanimeTVIE.ie_key()),
            default=24
        )
